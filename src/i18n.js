...
export const TRANSLATIONS = {
  en: {
    ...
    settings_perf_dynamic_hint: 'All layers — full 60fps animation',
    settings_perf_eco_hint:     'Minimal layers — saves CPU / battery',
    settings_perf_performance_hint: 'Adapts quality to your hardware automatically',
  ...
  th: {
    ...
    settings_perf_dynamic_hint: 'ทุก Layer — แอนิเมชัน 60fps เต็มรูปแบบ',
    settings_perf_eco_hint:     'Layer น้อย — ประหยัด CPU/แบตเตอรี',
    settings_perf_performance_hint: 'ปรับคุณภาพอัตโนมัติตามสเปคเครื่อง',
